...
#if defined(_WIN32)
extern "C" __declspec(dllexport) MocapApi::EMCPError __cdecl MCPGetGenericInterface(const char *pchInterfaceVersion, void **ppInterface);
#elif defined(__GNUC__) || defined(COMPILER_GCC) || defined(__APPLE__)
extern "C" __attribute__((visibility("default"))) MocapApi::EMCPError MCPGetGenericInterface(const char *pchInterfaceVersion, void **ppInterface);
#else
#error "Unsupported Platform."
#endif
}
